...
auth.post("/signup", validateRequestInput({ body: signupSchema }), AuthController.signup);
auth.post("/signin", validateRequestInput({ body: signinSchema }), AuthController.signin);
